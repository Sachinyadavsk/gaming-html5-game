...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://zettagame.com/aim_training/model.css">
  <link rel="stylesheet" type="text/css" href="https://zettagame.com/aim_training/styles.css">
...
<body>
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://zettagame.com/games/aim_training" style="font-size: 20px;color: #fff;">
  ...
  <script src="https://zettagame.com/aim_training/script.js"></script>
  <script src="https://zettagame.com/aim_training/modelpo.js"></script>
</body>
</html>
