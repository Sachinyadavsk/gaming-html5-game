...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://zettagame.com/trihand_tactics/styles.css" />
    <link rel="stylesheet" href="https://zettagame.com/trihand_tactics/model.css">
  ...
  <body>
      ...
      <div class="row">
          ...
          <div class="col-sm-12 col-md-6 mobile_game" style="background: #15130a;color: #776e65;font-family: "Clear Sans", "Helvetica Neue", Arial, sans-serif;">
    ...
    <button onclick="playGame('Rock');" class="move-btn text-center">
      <img src="https://zettagame.com/trihand_tactics/images/Rock-emoji.png" class="move-icon" />
    </button>
    
    <button onclick="playGame('Paper');" class="move-btn text-center">
      <img src="https://zettagame.com/trihand_tactics/images/Paper-emoji.png" class="move-icon" />
    </button>
    
    <button onclick="playGame('Scissors');" class="move-btn text-center">
      <img src="https://zettagame.com/trihand_tactics/images/Scissors-emoji.png" class="move-icon" />
    </button>
    ...
    <button
      ...
      updateScoreElement();
    "
      class="reset-score-btn text-center">Reset Score</button>
</div>
   ...
   <div class="container-fluid">
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://zettagame.com/games/trihand_tactics" style="font-size: 20px;color: #fff;">
     ...
     <script src="https://zettagame.com/trihand_tactics/modelpo.js"></script>
     <script src="https://zettagame.com/trihand_tactics/script.js"></script>
  </body>
</html>
