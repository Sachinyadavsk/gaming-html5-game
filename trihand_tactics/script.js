...
function playGame(playerMove) {
  ...
  <img src="https://game.reapbucks.com/trihand_tactics/images/${playerMove}-emoji.png" alt="rock" class="move-icon" />
  <img src="https://game.reapbucks.com/trihand_tactics/images/${computerMove}-emoji.png" alt="scissor" class="move-icon" />
  Computer`;
}
