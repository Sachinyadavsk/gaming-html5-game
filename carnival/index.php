...
<head>
  ...
  <link rel="stylesheet" href="https://zettagame.com/carnival/style.css">
  <link rel="stylesheet" href="https://zettagame.com/carnival/model.css">
...
<h2 style="margin-top:50px;">You have 8 seconds to hit as many targets as you can!</h2>
<div class="game-over text-center">
  <h1>Game Over!</h1>
  <a class="play-again" href="https://zettagame.com/carnival/">Play Again</a>
</div>
<ul class="game-area">
...
<div class="row">
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://zettagame.com/games/carnival" style="font-size: 20px;color: #fff;">
 ...
 <script src="https://zettagame.com/carnival/modelpo.js"></script>
</body>
</html>
