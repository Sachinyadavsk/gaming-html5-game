...
<head>
      ...
      <?php           
          include('confige.php');
            $game_res4=mysqli_query($con,"select * from meta_data where page='register'");
            $game_arr4=array();
   ...
   <body>
      <div class="nftg-app-alt a-cursor sidebar-add">
         ...
         <div class="nftg-thumb">
            <img src="https://zettagame.com/assets/images/authentication/authentication.png" alt="SCreate Account" class="parallax-image">
         </div>
         <!-- ==== / thumb end ==== -->
         <!-- ==== layout start ==== -->
                     ...
                     <div class="row justify-content-center">
                        <div class="col-12">
                           <div class="authentication__wrapper text-center">
                              <div class="mb-55">
                                 <h1 class="title-lg fw-8 stroked-text transform-none title-animation">Hello
                                    Gamer
                                 </h1>
                                 <p class="text-xl mt-12 text-alter">Getting Started Is Easy.</p>
                              </div>
                              <div class="authentication__inner">
                                
                              <form id="registrationForm" method="POST" action="https://zettagame.com/register-submit">
                                    ...
                                    <div class="input-single">
                                        ...
                                        <div class="ic-group pass">
                                            <i class="ti ti-key"></i>
                                            <i class="ti ti-eye-off show-pass"></i>
                                            <input type="password" name="password" id="password" placeholder="Enter Password" required>
                                        </div>
                                    </div>
                                    <div class="input-single mb-0">
                                        <label for="passwordCon">Confirm Password</label>
                                        <div class="ic-group pass">
                                            <i class="ti ti-key"></i>
                                            <i class="ti ti-eye-off show-pass"></i>
                                            <input type="password" name="passwordCon" id="passwordCon" placeholder="Confirm Password" required>
                                        </div>
                                    </div>
                                    
                                    <div class="btn-wrapper mt-40">
                                        <button class="btn--secondary" aria-label="Create Account" title="Create Account">Create Account</button>
                                    </div>
                                </form>
                                  <div class="mt-60 h-a text-start">
