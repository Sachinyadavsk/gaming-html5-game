...
<head>
    ...
    <link rel="stylesheet" href="https://zettagame.com/rivia_It/style.css">
    <link rel="stylesheet" href="https://zettagame.com/rivia_It/model.css">
...
<body>
    ...
    <div class="start_btn"><button>Click here to start </button></div>

    <div class="info_box">
        <div class="info-title"><span>Before you start with Trivia</span></div>
        <div class="info-list">
            ...
            <div class="info"> Rest are just useless things that do not matter </div>
        </div>
        <div class="buttons">
   ...
   <div class="container-fluid">
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://zettagame.com/games/trivia_It" style="font-size: 20px;color: #fff;">
                                ...
                                while ($rowimage = mysqli_fetch_assoc($resgameimage)) {
                                   ...
                                   <div class="col-sm-12 col-md-2">
                                       <a href="https://zettagame.com/games/<?php echo urlencode($rowimage['name']); ?>">
                                         <img src="https://game.reapbucks.com/images/games/<?php echo $rowimage['image']?>"
     ...
     <script src="https://zettagame.com/rivia_It/modelpo.js"></script>
    <script src="https://zettagame.com/rivia_It/js/index.min.js"></script>
    <script src="https://zettagame.com/rivia_It/js/questions.js"></script>
    <script src="https://zettagame.com/rivia_It/js/script.js"></script>
</body>
</html>