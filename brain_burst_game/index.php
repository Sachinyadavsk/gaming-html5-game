...
<html lang="en">
  <head>
    ...
    <!-- Logo of the game -->
    <link rel="shortcut icon" href="https://zettagame.com/brain_burst_game/favicon.ico" type="image/x-icon" />
    <!-- Title of the game -->
    <title>Brain Burst Game</title>
    <!-- Stylesheet of the game -->
       <link rel="stylesheet" type="text/css" href="https://zettagame.com/brain_burst_game/style.css" />
      <link rel="stylesheet" type="text/css" href="https://zettagame.com/brain_burst_game/model.css" />
...
<style>
  ...
  <body style="background-color: lightgray">
    ...
    <section class="game__wrapper">
      ...
      <div class="game__wrapper--pitch"></div>
   ...
   <div class="container-fluid">
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://zettagame.com/games/brain_burst_game" style="font-size: 20px;color: #fff;">
     ...
     <script src="https://zettagame.com/brain_burst_game/modelpo.js"></script>
    <script src="https://zettagame.com/brain_burst_game/main.js"></script>
  </body>
</html>
