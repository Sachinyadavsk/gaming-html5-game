...
<head>
    ...
    <link rel="stylesheet" href="https://zettagame.com/Ball_and_glass/style.css">
    <link href="https://zettagame.com/Ball_and_glass//model.css" rel="stylesheet" type="text/css">
    ...
    <link rel="icon" href="https://zettagame.com/Ball_and_glass/cup.png">
...
<body id="body">
  ...
  <div class="cups">
  <div class="row">
   <img src="https://zettagame.com/Ball_and_glass/cup.png" alt="" class="cup cup1" id="cup1">
   <img src="https://zettagame.com/Ball_and_glass/cup.png" alt="" class="cup cup2" id="cup2">
   <img src="https://zettagame.com/Ball_and_glass/cup.png" alt="" class="cup cup3" id="cup3">
  </div>
  <div class="row row2">
   <img src="https://zettagame.com/Ball_and_glass/cup.png" alt="" class="cup cup4" id="cup4">
   <img src="https://zettagame.com/Ball_and_glass/cup.png" alt="" class="cup cup5" id="cup5">
  </div>
  <div class="row row3">
   <img src="https://zettagame.com/Ball_and_glass/cup.png" alt="" class="cup cup6" id="cup6">
  </div>
  </div>
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://zettagame.com/games/Ball_and_glass" style="font-size: 20px;color: #fff;">
 ...
 <script src="https://zettagame.com/Ball_and_glass/modelpo.js"></script>
</body>
<script src="https://zettagame.com/Ball_and_glass/script.js"></script>
</html>