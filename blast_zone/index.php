...
<head>
    ...
    <link rel="stylesheet" href="https://zettagame.com/blast_zone/style.css">
      <link rel="stylesheet" href="https://zettagame.com/blast_zone/model.css">
...
<body>
    ...
    font-size: 30px; "><a href="https://kunjgit.github.io/GameZone/"><i style="color:white;" class="fas fa-home home-icon"></i></a></div>
        <div class="game-wrap">
            <canvas width="500px" height="540" id="game"></canvas>
            <article class="content">
                <h1 class="title"><span>B</span><span>l</span><span>a</span><span>s</span><span>t</span><span> </span><span>Z</span><span>o</span><span>n</span><span>e</span></h1>
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://zettagame.com/games/blast_zone" style="font-size: 20px;color: #fff;">
   ...
   <script src="https://zettagame.com/blast_zone/modelpo.js"></script>
    <script src="https://zettagame.com/blast_zone/script.js"></script>
</body>
</html>