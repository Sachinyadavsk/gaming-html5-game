...
<head>
    ...
    <link rel="stylesheet" href="https://zettagame.com/beat_a_mole/start.css">
    <link rel="stylesheet" href="https://zettagame.com/beat_a_mole/model.css">
...
<body style="background: #0c0f1e;">
    ...
    <div class="main">
        <div class="form-box">
            ...
            <br>
            <div class="start-btn">
                <a href="https://zettagame.com/beat_a_mole/game.php">Start</a>
              </div>
        </div>
    </div>
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://zettagame.com/games/beat_a_mole" style="font-size: 20px;color: #fff;">
 ...
 <script src="https://zettagame.com/beat_a_mole/modelpo.js"></script>
</body>
</html>