...
<head>
    ...
    <link rel="stylesheet" href="https://game.reapbucks.com/beat_a_mole/mole.css">
    <script src="https://game.reapbucks.com/beat_a_mole/mole.js"></script>
    
     <link href="https://game.reapbucks.com/beat_a_mole/model.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <h1 class="beat text-center">Beat a Mole</h1>
    <h2 id="score" class="text-center">0</h2>
    <!-- 3x3 -->
    <div id="board">
    </div>
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://game.reapbucks.com/game-start.php?games=beat_a_mole" style="font-size: 20px;color: #fff;">
                    ...
                    <div class="row">
                                 <?php 
                                include('confige.php');
                                $gameimage = "SELECT * FROM games where status='1' limit 18";
                                $resgameimage = mysqli_query($con, $gameimage);
                                $i = 1;
                                while ($rowimage = mysqli_fetch_assoc($resgameimage)) {
                                    ?>
                                   <div class="col-sm-12 col-md-2">
                                       <a href="https://game.reapbucks.com/game-start.php?games=<?php echo $rowimage['name'];?>">
 ...
 <script src="https://game.reapbucks.com/beat_a_mole/modelpo.js"></script>
</body>
</html>
