...
function startGame() {
    ...
    cells.forEach(cell => cell.style.backgroundImage = 'url("https://zettagame.com/treasure_hunt/assets/cell-bg.png")');
...
function handleCellClick(event) {
    ...
    if (cellId === treasureLocation) {
        event.target.style.backgroundImage = 'url("https://zettagame.com/treasure_hunt/assets/treasure.png")';
        clueElement.innerText = `Congratulations! You found the treasure in ${attempts} attempts.`;
    } else {
        event.target.style.backgroundImage = 'url("https://zettagame.com/treasure_hunt/assets/wrong.png")';
