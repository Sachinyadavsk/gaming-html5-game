...
<title>MotoX3M</title>
    ...
    <meta property="og:title" content="MotoX3M">
    <head>
    <script src="https://zettagame.com/motox3m/assets/lib/include/navbar.js"></script>
    <link rel="stylesheet" href="https://zettagame.com/motox3m/assets/lib/include/navbar.css">
    <link rel="stylesheet" href="https://zettagame.com/motox3m/css/style.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Lato">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="icon" href="https://zettagame.com/motox3m/assets/img/logotransparent.png" type="image/x-icon">
    <link href="https://zettagame.com/motox3m/model.css" rel="stylesheet" type="text/css">
...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2417935702588836"
  crossorigin="anonymous"></script>
<!-- game page -->
<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-2417935702588836" data-ad-slot="1705773220"
...
<script>
  ...
  <h1 style="text-align: center;
    position: relative;
    top: -266px;
    left: 0%;"><b>Cut The Rope Time Travel</b></h1>
  <p class="game_contents" style="background: #faf8ef;color:#776e65;padding: 11px;"><b>How to play:</b> Use your arrow keys to move the tiles. when the use the enter and space button !</p>
  <p>
    <a href="https://zettagame.com/motox3m/play/">
      <img src="https://zettagame.com/motox3m/play/game_20241213_135557.jpg"
        style="width: 481px;
    height: 373px;
    margin: 0;
    position: absolute;
    ...
    transform: translate(-50%, -50%);" class="img_picture1"></img>
    </a>
  </p>
  <p style="text-align:center; position:relative; top: 70%; left: 0%;">
    <a href="https://zettagame.com/motox3m/play/"><img class="img_picture2" src="https://zettagame.com/motox3m/play/play_games.jpeg"
        style="width: 120px;/* height: 105px; */margin: 0;position: absolute;/* top: 50%; *//* left: 50%; */-ms-transform: translate(-50%, -50%);transform: translate(-50%, -706%);">
      </img></a>
  </p>
</div> 
<div class="col-md-3"></div>
                        ...
                        <div id="modal"
                            ...
                            <div class="bg-dark rounded-lg shadow-lg w-1/2">
                                ...
                                <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                                    <a href="https://zettagame.com/games/motox3m" style="font-size: 20px;color: #fff;">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0"
  ...
  <script>
    ...
    <script src="https://zettagame.com/motox3m/modelpo.js"></script>
</body>
</html>