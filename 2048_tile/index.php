...
<head>
  <meta charset="utf-8">
  <title>2048</title>
  <link href="https://zettagame.com/2048_tile/style/main.css" rel="stylesheet" type="text/css">
  <link href="https://zettagame.com/2048_tile/style/model.css" rel="stylesheet" type="text/css">
...
<body style="background: #0c0f1e;">
            ...
            <div class="row">
                  ...
                  <div class="col-md-8">
                     <div class="row">
                           <div class="col-md-12">
                                 <div class="heading">
                                        <h1 class="title" style="#776e65;">2048</h1>
                                        <div class="scores-container">
                                            <div class="score-container" style="#776e65;">0</div>
                                            <div class="best-container" style="#776e65;">0</div>
                                        </div>
                                  </div>
                           </div>
                           <div class="col-md-12">
                               <div class="above-game" style=" display: flex;justify-content: space-around;margin-top: 10px;">
                                  <span class="game-intro" style="#776e65;">Join the numbers <br>and get to the <strong>2048 tile!</strong></span>
                                  <span><a class="restart-button">New Game</a></span>
                                </div>
                           </div>
                      </div>
                  </div>
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://zettagame.com/games/2048_tile" style="font-size: 20px;color: #fff;">
 ...
 <script src="https://zettagame.com/2048_tile/js/modelpo.js"></script>
  <script src="https://zettagame.com/2048_tile/js/bind_polyfill.js"></script>
  <script src="https://zettagame.com/2048_tile/js/classlist_polyfill.js"></script>
  <script src="https://zettagame.com/2048_tile/js/animframe_polyfill.js"></script>
  <script src="https://zettagame.com/2048_tile/js/keyboard_input_manager.js"></script>
  <script src="https://zettagame.com/2048_tile/js/html_actuator.js"></script>
  <script src="https://zettagame.com/2048_tile/js/grid.js"></script>
  <script src="https://zettagame.com/2048_tile/js/tile.js"></script>
  <script src="https://zettagame.com/2048_tile/js/local_storage_manager.js"></script>
  <script src="https://zettagame.com/2048_tile/js/game_manager.js"></script>
  <script src="https://zettagame.com/2048_tile/js/application.js"></script>
</body>
