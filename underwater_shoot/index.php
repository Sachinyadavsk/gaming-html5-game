...
<head>
    ...
    <link rel="stylesheet" href="https://zettagame.com/underwater_shoot/style.css">
    <link rel="stylesheet" href="https://zettagame.com/underwater_shoot/model.css">
...
<body>
    <div class="container">
      <div class="row">
          ...
          <div class="col-sm-12 col-md-6 mobile_game" style="background: #135e7a;color: #776e65;font-family: "Clear Sans", "Helvetica Neue", Arial, sans-serif;">
   ...
   <div class="container-fluid">
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://zettagame.com/games/underwater_shoot" style="font-size: 20px;color: #fff;">
    ...
    <script src="https://zettagame.com/underwater_shoot/modelpo.js"></script>
    <script src="https://zettagame.com/underwater_shoot/script.js"></script>
</body>
</html>
