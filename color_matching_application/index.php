...
<head>
    ...
    <link rel="stylesheet" href="https://zettagame.com/color_matching_application/style.css">
    <link rel="stylesheet" href="https://zettagame.com/color_matching_application/model.css">
...
<body>
      ...
      <div class="row">
          ...
          <div class="col-sm-12 col-md-6 mobile_game" style="background: #faf8ef;color: #776e65;font-family: "Clear Sans", "Helvetica Neue", Arial, sans-serif;">
              <div class="styles_draggable__uzjbU" style="transform: translate(0px, 0px);"><div>
                  <button id="openModalBtn" class="flex h-8 w-10 items-center justify-center rounded-r-full bg-primary-content shadow-md" style="padding: 0px 19px 6px;margin-left: -16px;border-right: 4px solid #fff;border-radius: 5px;border-bottom: none;border-left: none;border-top: none;">
        ...
        <h1 class="text-center">Color Match Game</h1>
        <div class="score-section">
            <p class="text-center">Score: <span id="score">0</span></p>
        </div>
        <div class="target-color-section">
            <p class="text-center">Target Color:</p>
            <div id="targetColor" class="color-box text-center"></div>
        </div>
        <div class="grid-section">
            <div class="grid" id="colorGrid"></div>
        </div>
        <button onclick="startGame()" class="new_start_now">Start New Game</button>
        <div class="row">
                  <div class="col-md-2"></div>
                   <div class="col-md-8"><p class="game_contents"><b>How to play:</b> Use your click the screen the mobile device and. Desktop and laptop using the space and enter button</p></div>
                    <div class="col-md-2"></div>
             </div>
   </div>
          <div class="col-md-3"></div>
                ...
                <div id="modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                  <div class="bg-dark rounded-lg shadow-lg w-1/2">
                     ...
                     <div class="flex items-center justify-between px-6 py-4 font-bold  ">
                        <a  href="https://zettagame.com/games/color_matching_application" style="font-size: 20px;color: #fff;">
 ...
 <script src="https://zettagame.com/color_matching_application/modelpo.js"></script>
    <script src="https://zettagame.com/color_matching_application/script.js"></script>
</body>
</html>
