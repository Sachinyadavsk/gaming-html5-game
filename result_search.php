                     ...
                     <div class="row align-items-center vertical-column-gap">
                        <div class="col-12 col-lg-6">
                           <div class="text-center text-lg-start">
                              <h2 class="fw-6 title-animation mt-8">Search Results for Games <img src="https://zettagame.com/assets/images/fire.png"
                                 alt="Image"> </h2>
                           </div>
                        </div>
                        ...
                        <div class="col-12">
                           <div class="trending__wrapper mt-60 ">
                                  ...
                                  if (isset($_POST['search'])) {
                                               ...
                                               <div class="trending__single van-tilt">
                                                  <div class="thumb ">
                                                     ...
                                                     <img src="https://zettagame.com/images/games/<?php echo $row['image']?>"
                                                           alt="<?php echo $row['name'];?>" style="height: 200px;width:220px;">
                                                     </a>
                                                  </div>
                                        ...
                                        ?>
                                            <div class="alert alert-warning">
                                               <strong>Warning!</strong> No search term entered.
                                            </div>
                                            <?php
                                    }
                     ...
                     <br>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <button class="btn btn-dark" style="margin-top: -31px;margin-right:6px;float: right !important;"
                                    onclick="myFunction()"> Read More &nbsp; <i id="toggle_icon"></i></button>
