function startSim() {
  ...
  var img1 = Bdy.rectangle(contW / 2 + 150, 500, 120, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/one.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img2 = Bdy.rectangle(contW / 2 - 150, 460, 170, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/two.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img3 = Bdy.rectangle(contW / 2 + 250, 420, 87, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/three.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img4 = Bdy.rectangle(contW / 2 - 75, 380, 140, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/four.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img5 = Bdy.rectangle(contW / 2 - 74, 540, 146, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/five.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img6 = Bdy.rectangle(contW / 2 + 174, 490, 106, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/six.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img7 = Bdy.rectangle(contW / 2 - 142, 440, 142, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/seven.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img8 = Bdy.rectangle(contW / 2 - 10, 260, 88, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/eight.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img9 = Bdy.rectangle(contW / 2 - 242, 420, 150, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/nine.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img10 = Bdy.rectangle(contW / 2 + 60, 300, 104, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/ten.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img12 = Bdy.rectangle(contW / 2 - 59, 260, 102, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/twelve.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img14 = Bdy.rectangle(contW / 2 - 110, 296, 120, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/fourteen.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var img15 = Bdy.rectangle(contW / 2 - 10, 260, 156, 50, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/matter/fifteen.png",
        xScale: 1,
        yScale: 1,
      },
    },
