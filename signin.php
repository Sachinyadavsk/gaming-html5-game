...
<head>
      ...
      <?php           
          include('confige.php');
            $game_res4=mysqli_query($con,"select * from meta_data where page='login'");
            $game_arr4=array();
                     ...
                     <div class="col-12">
                        <div class="authentication__wrapper text-center">
                           ...
                           <div class="authentication__inner">
                              ...
                              <form action="https://zettagame.com/login-submit" method="post">
                                 ...
                                 <div class="input-single mb-0">
                                    ...
                                    <p class="text-end"><a href="forget-password">Forget Password?</a>
                                    </p>
                                 </div>
                                 <div class="btn-wrapper mt-40">
                                    <button class="btn--secondary" aria-label="login" title="login">
                                       Login </button>
                                 </div>
                              </form>
                              
                              <div class="mt-60 h-a text-start">
                                 <p class="mt-8">Don't have an account? <a href="register">Sign Up!</a>
                                 </p>
                              </div>
                           </div>
                        </div>
